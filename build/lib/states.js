...
function getChannelStates() {
    const states = {
        ...
        current_art: {
            ...
            write: false,
            role: 'media.cover',
            desc: 'Stable cover image of the current track (not the live now-playing file)',
        ...
        next_title: {
            ...
            write: false,
            role: 'media.title',
            desc: 'Title of the track Sonos will play on Next (respects shuffle)',
            name: 'Next title',
        },
        next_artist: {
            def: '',
            ...
            write: false,
            role: 'media.artist',
            desc: 'Artist of the track Sonos will play on Next',
            name: 'Next artist',
        },
        next_album: {
            def: '',
            ...
            write: false,
            role: 'media.album',
            desc: 'Album of the track Sonos will play on Next',
            name: 'Next album',
        },
        next_art: {
            def: '',
        ...
        current_uri: {
            ...
            write: false,
            role: 'media',
            desc: 'URI that can restore the current source',
            name: 'Current URI',
        },
        current_metadata: {
            def: '',
            ...
            write: false,
            role: 'media',
            desc: 'DIDL metadata of the current source',
