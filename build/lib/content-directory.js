...
exports.hasHomeTheater = hasHomeTheater;
 ...
 */
function isPlayingTv(transportUri, trackUri) {
...
const homeTheaterCache = new Map();
/**
 ...
 */
async function hasHomeTheater(baseUrl) {
...
function getMediaRoot(services, labels, playerUuid, options) {
